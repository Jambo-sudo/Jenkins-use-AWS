...
In addition, you also need to add 3 similar rules to open 8080 for GitHub's webhook if your wanna use it. In these 3 rules, change the source to the [IP address of GitHub hook](https://api.github.com/meta). 

<b>Note</b>: You can set source to 0.0.0.0/0 as well. But we do not recommend this because it will make your jenkins manager open to everyone. 
...
In the first command, you can choose the corresponding [Jenkins version](https://pkg.jenkins.io/) according to your OS. We use the redhat-stable jenkins repo for our system, if you using the Amazon Linux you can use this jenkins version as well.
...
2. Source Code Management -> Git. Give the Github repository URL and credentials, you can [copy our project](https://github.com/Jambo-sudo/Historical-document-layout-analysis) or use your own project. 
